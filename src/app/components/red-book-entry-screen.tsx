...
const PRIORITIES: { label: Priority; sel: { bg: string; border: string; color: string } }[] = [
  { label: "Low", sel: { bg: "#E3F2FD", border: "#1565C0", color: "#1565C0" } },
  { label: "Medium", sel: { bg: "#FFF8E1", border: "#B8860B", color: "#B8860B" } },
  { label: "High", sel: { bg: "#FFF3E0", border: "#E65100", color: "#E65100" } },
  { label: "Urgent", sel: { bg: "#FFEBEE", border: "#C62828", color: "#C62828" } },
];
...
export function RedBookEntryScreen() {
  ...
  const [priority, setPriority] = useState<Priority>(isNew ? "Medium" : "High");
  ...
  return (
    <div className="font-['Inter'] space-y-0">
      ...
      <div className="mt-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0 relative">
            ...
            <button
              type="button"
              className="absolute right-2 top-2.5 rounded-full cursor-pointer transition-all duration-150 active:scale-[0.95] flex items-center justify-center"
              style={{ width: 28, height: 28, backgroundColor: "#0E2646" }}
      ...
      <div
        ...
        style={{ padding: "14px 0", marginTop: 16 }}
      >
        <div className="flex items-center gap-2.5">
          <FlagIcon active={actionRequired} />
      ...
      >
        ...
        >
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      backgroundColor: isSel ? p.sel.bg : "#FFFFFF",
                      border: `1px solid ${isSel ? p.sel.border : "#D4D4D0"}`,
                      color: isSel ? p.sel.color : "rgba(26,26,26,0.50)",
                    }}
                  >
                    {p.label}
                  </button>
          ...
          {/* ── Assign To ── */}
          <div className="flex items-center gap-3 mt-3" ref={assignRef}>
            <label className="font-['Inter'] shrink-0" style={{ width: 85, fontSize: 14, fontWeight: 600, color: "#1A1A1A" }}>
              Assign To
            </label>
            <div className="flex-1 min-w-0 relative">
