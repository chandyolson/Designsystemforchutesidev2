            ...
            <div
              className={
                isDesktop
                  ...
                  : "relative w-full max-w-[420px] md:max-w-[768px]"
              }
            >
              <motion.div
                ref={sheetRef}
                ...
                className={
                  isDesktop
                    ? "bg-white font-['Inter'] flex flex-col pointer-events-auto rounded-2xl"
                    : "absolute bottom-0 left-0 right-0 bg-white font-['Inter'] flex flex-col pointer-events-auto"
                }
                style={{
                  ...(isDesktop
                    ? { maxHeight: "70vh", boxShadow: "0 24px 60px rgba(0,0,0,0.25)" }
                    : {
